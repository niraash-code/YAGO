        ...
        ReactDOM.createPortal(
          <AnimatePresence>
            <motion.div
              ...
              className="px-3 py-1.5 bg-card border border-border rounded shadow-2xl"
            >
              <span className="text-[9px] font-black uppercase tracking-widest text-foreground whitespace-nowrap">
                {content}
              </span>
            </motion.div>
          </AnimatePresence>,
