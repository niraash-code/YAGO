...
- [Mod Management](user/mod-management.md) - Importing and organizing mods
- [Launcher Features](user/launcher-features.md) - Profiles, FPS unlock, Linux support
- [Safety](user/safety.md) - Streamer mode and account protection
